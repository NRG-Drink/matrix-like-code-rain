...
//namespace Kemartec.Checkliste.Build.GitHub;

//public class MyGitHubMarkdownSummaryGenerator : IPipelineGlobalHooks
//{
//    private const long MaxFileSizeInBytes = 1 * 1024 * 1024; // 1MB

//    private readonly IAfterPipelineLogger _afterPipelineLogger;

//    public MyGitHubMarkdownSummaryGenerator(IAfterPipelineLogger afterPipelineLogger)
//    {
...
//    {
//        var title = GetTitle(pipelineSummary);
...
//        await WriteFile(pipelineContext, stepSummaryVariable, mermaid, table, exception, title);
//    }

//    private object GetTitle(PipelineSummary pipelineSummary)
//    {
//        return $"# ModularPipelines Summary ({pipelineSummary.Status})";
//    }

//    private async Task WriteFile(IPipelineHookContext pipelineContext, string stepSummaryVariable, string mermaid,
//        string table, string exception, object title)
//    {
